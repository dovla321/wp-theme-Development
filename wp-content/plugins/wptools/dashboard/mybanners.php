...
if ($x < 2) {
    ...
    _e('If you like this product, please write a few words about it. It will help other people find this useful plugin more quickly.<br><b>Thank you!</b>', 'wptools');
?>
    <br /><br />
    <a href="http://wptoolsplugin.com/share/" class="button button-medium button-primary"><?php _e('Rate or Share', 'wptools'); ?></a>
<?php
} else {
    echo '<h2>Please help us keep the plugin live & up-to-date</h2>';
    _e('If you use & enjoy WP Tools Plugin, please rate it on WordPress.org. It only takes a second and helps us keep the plugin live and maintained. Thank you!', 'wptools');
?>
    <br /><br />
