...
function wptools_print_html_result(array $data, bool $showServerName = true,$title)
{
  ...
  //  if (isset($data['sysinfo']['mysql_version'])) {
    ...
    //    $result .= '<tr class="even"><td>MySQL Total</td><td>' . wptools_h($data['benchmark']['mysql_total']) . '</td></tr>';
        $result .= '</tbody>';
 //   }
    
    //$result .= '<thead><tr><th>Total</th><th>' . wptools_h($data['benchmark']['total']) . '</th></tr></thead>';
