...
function wptools_contextual_help_dashboard($screen)
{
    ...
    if (trim($screen->id) === "wp-tools_page_wptools_options31") 
       $myhelp .=     'In the DASHBOARD screen you will find useful information about your server.';
    else
       $myhelp .= '<a href="'.$site2.'" >Here are the link to the Dashboard Plugin Page with more useful information.</a>';
    $myhelp .= '
    <br />
    <br />
    You will find also links to 
    <a href="'.$site.'" >StartUp Guide</a> and Settings, Troubleshooting Guide Page and Support Page.
    <br /> 
    <br /> 
    <a href="https://wptoolsplugin.com/blog/">
    Here are the link to our free blog with a lot of tips and tricks and about how to use this tool.
	</a>
    <br />
    ';
    $screen->add_help_tab(array(
        'id' => 'wptools-overview-tab',
        'title' => __('Overview', 'wptools'),
        'content' => '<p>' . $myhelp . '</p>',
    ));
    return;
}
function wptools_contextual_help_settings($screen)
{
    ...
    $myhelp = '
    <br />
    In the SETTINGS screen you will find many tabs, with useful information as StartUP Guide.
    <br />
    <br />
    You will find also fields and controls to configurate the plugin. Take some time to open each tab and mark that you want.
    <br />
    <br />  
    <a href="'.$site.'" >Here are the link to the Dashboard Plugin Page with more useful information.</a> 
    <br />
    <br />
    ';
    $screen->add_help_tab(array(
...
function wptools_admin_print_footer_scripts()
{
 ...
 ?>
        ...
        jQuery(document).ready( function($) {
            ...
            $pointer_content = '<h3>Open WP Tools Plugin Here!</h3>';
            $pointer_content = $pointer_content + '<p>Just Click Over WP Tools, then Go To Settings=>StartUp Guide.';
