   ...
   <input type="hidden" name="registration" value="<?php the_field('registration');?>">
	...
	<div class="form-group row">
       ...
       <div class="col-lg-6 mb-2">
          ...
          <input type="Country" name="country" placeholder="Country" class="form-control" required>
	...
	<div class="form-group">
		...
		<button type="submit" class="btn btn-success btn-lg w-100">Send your enquiry</button>
	</div>
